...
int main(){
	...
	tearDown();
	testEnded();
	testStarted("test_isEmpty_gives_true_for_empty_queue");
	setup();
		test_isEmpty_gives_true_for_empty_queue();
	tearDown();
	testEnded();
	testStarted("test_is_not_Empty_gives_false_for_full_queue");
	setup();
		test_is_not_Empty_gives_false_for_full_queue();
	tearDown();
	testEnded();
	testStarted("test_isFull_gives_true_for_full_queue");
	setup();
		test_isFull_gives_true_for_full_queue();
	tearDown();
	testEnded();
	testStarted("test_dequeue_is_not_Full_gives_false_for_non_full_queue");
	setup();
		test_dequeue_is_not_Full_gives_false_for_non_full_queue();
	tearDown();
	testEnded();
